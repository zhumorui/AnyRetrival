"""
Source code adapted from JunukCha's DINOv2 PCA Visualization:
Repository: https://github.com/JunukCha/DINOv2_pca_visualization
File: main.py
"""
...
def main(save_fg_mask=False, img_size=224, output_folder="outputs"):
    ...
    images = [transform(Image.open(f"data/datasets/roxford5k/jpg/all_souls_00000{i}.jpg")) for i in range(start_idx, end_idx+1)]
